object FOPagoTransfInterb: TFOPagoTransfInterb
  ...
  object pnlConstancia: TPanel
    ...
    object gbDatosComision: TGroupBox
      ...
      Width = 355
      Height = 167
      Caption = 'Datos Comisi'#243'n por Transferencia Interbancaria'
      TabOrder = 2
      ...
      object lblImporteComision: TLabel
        ...
        Width = 118
        Height = 17
        Caption = 'Importe por Comisi'#243'n'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -12
        Font.Name = 'Comic Sans MS'
      ...
      object dblcdCtaCnt: TwwDBLookupComboDlg
        ...
        MaxWidth = 0
        MaxHeight = 209
        OnCloseDialog = dblcdCtaCntCloseDialog
        TabOrder = 0
        AutoDropDown = False
        ShowButton = True
        AllowClearKey = True
      ...
      object dblcdCCosto: TwwDBLookupComboDlg
        ...
        MaxWidth = 0
        MaxHeight = 209
        OnCloseDialog = dblcdCCostoCloseDialog
        TabOrder = 2
        AutoDropDown = False
        ShowButton = True
        AllowClearKey = False
